  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-2">Welcome to MindMate AI</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {/* Journal Card */}
        <a href="/journal" className="bg-background dark:bg-card rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 flex flex-col items-center text-center">
        ...
        {/* AI Chat Card */}
        <a href="/chat" className="bg-background dark:bg-card rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 flex flex-col items-center text-center">
        ...
        {/* Mood Tracker Card */}
        <a href="/mood" className="bg-background dark:bg-card rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 flex flex-col items-center text-center">
          <div className="bg-pink-100 dark:bg-pink-900/30 p-3 rounded-full mb-3">
